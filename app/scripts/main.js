    ...
    $(function () {
        ...
        if ($('a[href*="#"]:not([href="#"])').click(function () {
            ...
            new Waypoint({
                ...
                handler: function (t) {
                    "up" === t && ($("body").removeClass("menu-light"),
                ...
                new Waypoint({
                    element: document.getElementById("about-us"), handler: function (t) {
                        "down" === t && ($("body").addClass("menu-light"),
                ...
                new Waypoint({
                    element: document.getElementById("we-provide"), handler: function (t) {
                        "down" === t && ($("body").removeClass("menu-light"),
        ...
        var T = {
            intro: function () {
                ...
                t.to(".logo", .3, {opacity: 1, y: 0}).to(".request", .3, {opacity: 1, y: 0})
                    .to(".hamburger-menu", .3, {opacity: 1, y: 0}, "-= 0.3")
                    .staggerTo("#header-intro .js-fadeIn", .6, {opacity: 1, y: 0}, .1, "sync")
                    .to($(".copyright"), .3, {opacity: 1, y: 0}, "sync")
                    .fromTo(".meter", .3, {x: "-8px"}, {opacity: 1, rotation: "-90deg", x: "0"}, "sync")
                    .staggerTo(".sidebar-item", .5, {opacity: 1, x: "0%"}, .1, "-= 0.3")
            },
            reIntro: function () {
                TweenMax.to("#header-intro", .3, {opacity: 1, y: "0px"})
            },
            backgroundChanger: function (t) {
                TweenMax.to(".global-background", .3, {backgroundColor: t})
            },
